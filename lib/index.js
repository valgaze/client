...
/**
* METHOD: https( bool )
*	Instructs OpenTSDB whether or not to use https://__url__ or http://__url__, later consumed by opentsdb-url
*
* @param {Boolean} [bool] - boolean flag, use https or not
* @returns {Client} Client instance
*/
Client.prototype.https = function( bool ) {
	if ( !arguments.length ) {
		return this._https;
	}
	if ( typeof bool !== 'boolean' ) {
		throw new TypeError( 'https()::invalid input argument. Flag must be a boolean.' );
	}
	this._https = bool;
	return this;
}; // end METHOD https()
